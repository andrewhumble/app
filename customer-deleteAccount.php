            ...
            <div class="row h-30 content">
                ...
                <div class="row">
                    <div class="col-sm-10 text-left">
                        <div class="ml-3 mt-5">
                            <h1 style="font-family: Nunito; color: #3F3D56">Are you sure you want to delete your account?</h1>
                            <h6 style="font-family: Nunito; color: #3F3D56">This action cannot be undone.</h6>
                        </div>
                        <div class="ml-3 mt-5">
                            <form method="post">
                            <button style="background-color: #C8D8E4; border: 5px solid #C8D8E4; font-family: Nunito; color: #3F3D56; font-size: 160%;" class="btn btn-primary" type="submit" name="submitbutton"><strong>Delete My Account</strong></button>
                            </form>
                        </div>
                    </div>
                </div>
