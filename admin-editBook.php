            ...
            <form method="post">
                <div class="QMiddle" style="width: 350px;">
                    <form action="">
                        ...
                        <p><b>Author</b></p><br>
                        <input class="Text" type="text" id="btitle" name="author"
                            placeholder="<?php echo $author ?>"><br><br>

                        <p><b>Genre</b>
                        <p><br>
                            <input class="Text" type="text" id="btitle" name="genre"
                                placeholder="<?php echo $genre ?>"><br><br>
                    </form>
                </div>
                <div class="QEnd" style="width: 300px;">
                    <form action="">
                        <p><b>Inventory:</b></p>
                        <input class="Text" type="text" id="btitle" name="inventory"
                            placeholder="<?php echo $inventory ?>"><br><br>

                        <p><b>Price</b></p><br>
                        <p>$</p><input class="TextPrice" type="text" id="btitle" name="price"
                            placeholder="<?php echo $price ?>"><br><br>

                        <p><b>ISBN</b></p><br>
                        <input class="TextISBN" type="text" id="btitle" name="isbn"
                            placeholder="<?php echo $isbn ?>"><br><br>
                    </form>
                </div>
