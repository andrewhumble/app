...
<body>
  ...
  <main>
    ...
    <div class="container-fluid mt-4 text-center pb-5">
      <h6 class="m-1 pt-4" style="font-family: Nunito; color: rgba(63, 61, 86, 1)">Don't have an account? Click <a href="registration.php" class="linkHere">here</a> to register!</h6>
      <div class="row h-75 justify-content-md-center" style="background-image: url('./images/undraw_road_to_knowledge_m8s0.svg'); background-size: contain; background-repeat: no-repeat; background-position: center;">
